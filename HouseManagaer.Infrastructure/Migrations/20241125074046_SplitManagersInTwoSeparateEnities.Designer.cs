...
namespace HouseManager.Infrastructure.Migrations
{
    ...
    [Migration("20241125074046_SplitManagersInTwoSeparateEnities")]
    partial class SplitManagersInTwoSeparateEnities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HouseManager.Infrastructure.Data.Models.Cashier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasComment("Primary identifier of the cashier");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Id"));

                    b.Property<DateTime>("EndDate")
                        .HasColumnType("datetime2")
                        .HasComment("Due date of assignment to the cashier position");

                    b.Property<int>("HouseOrganizationId")
                        .HasColumnType("int")
                        .HasComment("Managed by the cashier house organization");

                    b.Property<bool>("IsActive")
                        .HasColumnType("bit")
                        .HasComment("Current status of the cashier");

                    b.Property<string>("Name")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasComment("Cashier full name");

                    b.Property<string>("PhoneNumber")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasComment("Phone number of the cashier");

                    b.Property<DateTime>("StartDate")
                        .HasColumnType("datetime2")
                        .HasComment("Start date of assignment to the cashier position");
            ...
            modelBuilder.Entity("HouseManager.Infrastructure.Data.Models.President", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasComment("Primary identifier of the president");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Id"));

                    b.Property<DateTime>("EndDate")
                        .HasColumnType("datetime2")
                        .HasComment("Due date of assignment to the president position");

                    b.Property<int>("HouseOrganizationId")
                        .HasColumnType("int")
                        .HasComment("Managed by the president house organization");

                    b.Property<bool>("IsActive")
                        .HasColumnType("bit")
                        .HasComment("Current status of the president");

                    b.Property<string>("Name")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasComment("President full name");

                    b.Property<string>("PhoneNumber")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasComment("Phone number of the president");

                    b.Property<DateTime>("StartDate")
                        .HasColumnType("datetime2")
                        .HasComment("Start date of assignment to the president position");
